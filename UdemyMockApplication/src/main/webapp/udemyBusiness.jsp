...
<body>
    ...
    <div class="container mt-5">
        <h1 class="text-center">Udemy Business</h1>
        <p class="text-center mt-3">
            Udemy Business helps organizations and teams learn in-demand skills with access to the best online courses.
        </p>
        <div class="text-center mt-5">
            <a href="plans.jsp" class="btn btn-primary btn-lg">Explore Plans</a>
        </div>
    </div>
